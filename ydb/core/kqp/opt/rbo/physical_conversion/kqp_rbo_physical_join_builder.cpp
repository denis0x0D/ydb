...
void TPhysicalJoinBuilder::PrepareJoinFilters(TExprNode::TPtr& leftLambda, TExprNode::TPtr& rightLambda, TExprNode::TPtr& commonLambda,
    ...
    if (joinType == "Left") {
        // DqBlockHashJoinCore makes non-optional right filter arguments optional for a left join.
        // Restore their input types before substituting them into the already typed logical predicate.
        // Originally optional columns must stay optional.
