...
private:
    ...
    // Names for generated columns have to stay unique across the whole query: two selects joined
    // together share one map, so a counter reset per select collides there.
