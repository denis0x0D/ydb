...
void Print(TOLAPPredicateNode &node, int level) {
    Cerr << node.ExprNode->Content() << " can be pushed " << node.CanBePushedApply <<  " level " << level << Endl;
