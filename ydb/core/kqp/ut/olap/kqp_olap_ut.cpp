...
FROM `/Root/test_peephole`
 ...
 LIMIT 1000001
    ...
    Y_UNIT_TEST(OlapFilterPeephole) {
        ...
        auto res = session.ExecuteSchemeQuery(R"(
            CREATE TABLE `/Root/test_peephole` (
            Db Utf8 not null,
            Suite Utf8 not null,
